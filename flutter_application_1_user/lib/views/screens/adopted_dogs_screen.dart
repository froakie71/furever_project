...
class _AdoptedDogsScreenState extends State<AdoptedDogsScreen> {
      ...
      for (var adoption in adoptionsSnapshot.docs) {
        try {
          ...
          adoptedDogs.add({
            ...
            'adoptionDate': adoptionData['approvedAt'] ??
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed: () {
                      _showScheduledCheckups(context, dog);
                    },
                  ),
                ],
              ),
  ...
  void _showScheduledCheckups(BuildContext context, Map<String, dynamic> dog) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              '${dog['dogName']}\'s Scheduled Checkups',
              style: const TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.bold,
                color: Color(0xFF32649B),
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                    return const Center(
                      child: Text('No scheduled checkups found.'),
                    );
                  }
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final checkup =
                          checkups[index].data() as Map<String, dynamic>;
                      final status = checkup['status'] ?? 'pending';
                      final date = (checkup['date'] as Timestamp).toDate();
                      final description =
                          checkup['description'] ?? 'No description';
